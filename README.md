...
| **🛠️ Tools, Productivity & Utilities** | Productivity apps, file managers, system tweaks, notes, and utilities. | `13376 apps` | [**Explore →**](docs/categories/tools-utilities.md) |
...
| **📚 Complete A–Z Index** | Full searchable table of all 16965 cataloged applications | `16965 apps` | [**View Full Table →**](docs/all-apps.md) |
