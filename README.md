...
| **🛠️ Tools, Productivity & Utilities** | Productivity apps, file managers, system tweaks, notes, and utilities. | `13386 apps` | [**Explore →**](docs/categories/tools-utilities.md) |
...
| **📚 Complete A–Z Index** | Full searchable table of all 16976 cataloged applications | `16976 apps` | [**View Full Table →**](docs/all-apps.md) |
